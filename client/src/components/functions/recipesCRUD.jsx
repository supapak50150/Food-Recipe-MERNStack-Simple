...
// export const createRecipes = async (recipe, authtoken) =>
...
export const getRecipes = async (authtoken) =>
  ...
  export const getRecipesHome = async () => {
    try {
      const response = await axios.get(`${import.meta.env.VITE_REACT_APP_API}/recipe-home`);
...
// export const updateRecipes = async (recipe,id,authtoken) =>
export const updateRecipes = async (formData,id,authtoken) =>
  await axios.put(`${import.meta.env.VITE_REACT_APP_API}/recipe/${id}`, formData,{
    headers: {
      authtoken,
    },
  });
